...
def get_table_for_chr(chr_num, keep_path=None, output_name=None):
    ...
    df.drop(df[(df["MAF_A"] < 0.05) | (df["MAF_B"] < 0.05)].index, inplace=True)
...
def create_parser():
    ...
    parser.add_argument('-out', type=str, default=None, dest="output_name")
    return parser
